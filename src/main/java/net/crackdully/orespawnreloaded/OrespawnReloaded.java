...
import net.crackdully.orespawnreloaded.block.ModBlocks;
...
@Mod(OrespawnReloaded.MOD_ID)
public class OrespawnReloaded
{
    public static final String MOD_ID = "orespawnreloaded";
